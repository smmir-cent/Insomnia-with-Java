...
public class RequestSaving {
    ...
    public static void saveRequest(String group, HttpRequest request) {
        ...
        try {
            fos = new FileOutputStream("D:/Fourth semester/Advanced Programming/HW/HW5/3/MidTermProjectThirdPhase/Groups/"+group+".txt");
    ...
    public static void loadRequests(String group) {
        File file =new File("D:/Fourth semester/Advanced Programming/HW/HW5/3/MidTermProjectThirdPhase/Groups/"+group+".txt");
        //existing file or not-empty or not
        if(file.exists()&&file.length()!=0){
            //reade it
            FileInputStream fis = null;
            try {
                fis = new FileInputStream("D:/Fourth semester/Advanced Programming/HW/HW5/3/MidTermProjectThirdPhase/Groups/"+group+".txt");
            } catch (FileNotFoundException e) {
                e.printStackTrace();
            }
    ...
    public static void printGroups() {
        ...
        if(flag) {
            try {
                new File("D:/Fourth semester/Advanced Programming/HW/HW5/3/MidTermProjectThirdPhase/Groups/default.txt").createNewFile();
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public static void createGroup(String group){
        try {
            new File("D:/Fourth semester/Advanced Programming/HW/HW5/3/MidTermProjectThirdPhase/Groups/"+group+".txt").createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
