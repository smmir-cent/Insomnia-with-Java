...
public class GETRequest extends HttpRequest {
     ...
     */
    public GETRequest(URL url, HashMap<String, String> headers,boolean displayingHeader,boolean follow,String saveFilePath,String groupSave) throws IOException {
