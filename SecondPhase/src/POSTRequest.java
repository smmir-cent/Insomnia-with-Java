...
/**
 * this class represents a request whose method is POST.
...
public class POSTRequest extends HttpRequest {
    ...
    public POSTRequest(URL url, HashMap<String, String> headers, boolean displayingHeader, boolean follow, String saveFilePath, String groupSave, String uploadBinary, HashMap<String, String>  multiPartBody) {
    ...
    public HttpResponse method() {
        try {
            ...
            super.getConnection().setRequestMethod("POST");
